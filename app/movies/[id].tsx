    ...
    return (
        ...
        <ScrollView contentContainerStyle={{paddingBottom: 80}}>
                ...
                <View className='flex-col items-start justify-center mt-5 px-5'>
                    ...
                    {/* only a surface-level TS error */}
                    {/* variables are not undefined, they render just fine */}
        ...
        <TouchableOpacity className='absolute bottom-5 left-0 right-0 mx-5 bg-accent rounded-lg py-3.5 felx flex-row items-center justify-center z-50' onPress={router.back}>
